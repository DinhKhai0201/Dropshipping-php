...
spl_autoload_register(function ($classname)  {
	...
	if($classname == "Mobile_Detect") {
    include_once("vendor/helpers/vendor_mobiledetect_helper.php");  return;
  } 
  if($classname == "vendor_aws") {
    include_once("vendor/helpers/vendor_aws.php");  return;
  }
