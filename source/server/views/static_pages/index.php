...
<div class="top-container"><script type="text/javascript" src="//maps.googleapis.com/maps/api/js?v=3.17"></script>
...
<div id="store_map" style="min-height: 300px; width: 100%;"></div></div>        <div class="main-container col1-layout">
                        ...
                        <div class="col-main">
                            <div class="std">
                                <div class="content-row" style="padding: 40px 0 60px;">
                                    ...
                                    <p style="font-family:'Open Sans';font-size:15px;font-weight:400;line-height:1.8;margin-bottom:20px;color:#7b858a;">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.
                                    </p>
                                    <p style="font-family:'Open Sans';font-size:15px;font-weight:400;line-height:1.8;margin-bottom:20px;color:#7b858a;">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                                    </p>
                                    <p style="font-family:'Open Sans';font-size:18px;font-weight:400;line-height:1.5;margin-bottom:20px;color:#21293c;">
