                        ...
                        <div class="fieldset">
                            ...
                            <ul class="form-list">
                                    ...
                                    <div class="customer-name">
                                        <div class="field name-firstname">
                                            <label for="firstname" class="required"><em>*</em>First
                                                Name</label>
                                            <div class="input-box">
                                                <input type="text" id="firstname" name="user[firstname]" value="<?php echo $_SESSION['user']['firstname']; ?>" title="First Name" maxlength="255" class="input-text required-entry" />
                                            </div>
                                        </div>
                                        <div class="field name-lastname">
                                            <label for="lastname" class="required"><em>*</em>Last
                                                Name</label>
                                            <div class="input-box">
                                                <input type="text" id="lastname" name="user[lastname]" value="<?php echo $_SESSION['user']['lastname']; ?>" title="Last Name" maxlength="255" class="input-text required-entry" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="wide">
                                    ...
                                    <div class="input-box">
                                        <input type="text" name="user[email]" id="email" title="Email" value="<?php echo $_SESSION['user']['email']; ?>" class="input-text " />
                                    </div>
                                </li>
                                <li class="fields">
                                    <div class="field">
                                        ...
                                        <div class="input-box">
                                            <input type="text" name="user[phone]" value="<?php echo $_SESSION['user']['phone']; ?>" title="Telephone" class="input-text   required-entry" id="telephone" />
                                        </div>
                                    </div>
                                    <div class="field">
