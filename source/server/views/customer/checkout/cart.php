    ...
    <div class="main container">
        <div class="row">
            <div class="col-main col-lg-9">
                ...
                <script type="text/javascript" src="https://www.portotheme.com/magento/porto/js/varien/accordion.js"></script>
                <script type="text/javascript" src="https://www.portotheme.com/magento/porto/skin/frontend/base/default/js/opcheckout.js"></script>
                <ol class="opc" id="checkoutSteps">
                    <li id="opc-billing" class="section allow">
                        ...
                        <div id="checkout-step-billing" class="step a-item" style="display:none;">
                                ...
                                <fieldset>
                                        ...
                                        <li class="wide">
                                            ...
                                            <div class="input-box">
                                                <select name="billing_address_id" id="billing-address-select" class="address-select" title="" onchange="billing.newAddress(!this.value)">
                                                    <option value="513">a a, 324234 324234, 234, District of
                                                        Columbia 5555, United States</option>
                                                    <option value="514" selected="selected">a a, 324234 asd,
                                                        sdf, District of Columbia 55554, United States
                                                    </option>
                                        ...
                                        <li id="billing-new-address-form" style="display:none;">
                                            <fieldset>
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="control">
                                                        <input type="checkbox" name="billing[save_in_address_book]" value="1" title="Save in address book" id="billing:save_in_address_book" onchange="if(window.shipping) shipping.setSameAsBilling(false);" class="checkbox" /><label for="billing:save_in_address_book">Save in
                                                            address book</label>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="buttons-set" id="billing-buttons-container">
                                        ...
                                        <span class="please-wait" id="billing-please-wait" style="display:none;">
                                            <img src="https://www.portotheme.com/magento/porto/skin/frontend/smartwave/porto/images/opc-ajax-loader.gif" alt="Loading next step..." title="Loading next step..." class="v-middle" /> Loading next step... </span>
                                    </div>
                            ...
                            <script type="text/javascript">
                                //<![CDATA[
                                var billing = new Billing('co-billing-form', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/getAddress/address/', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/saveBilling/');
                                var billingForm = new VarienForm('co-billing-form');

                                //billingForm.setElementsRelation('billing:country_id', 'billing:region', 'http://www.portotheme.com/magento/porto/index.php/demo4_en/directory/json/childRegion/', 'Select State/Province...');
                    ...
                    <li id="opc-shipping" class="section">
                        ...
                        <div id="checkout-step-shipping" class="step a-item" style="display:none;">
                                        ...
                                        <div class="input-box">
                                            <select name="shipping_address_id" id="shipping-address-select" class="address-select" title="" onchange="shipping.newAddress(!this.value)">
                                                <option value="513">a a, 324234 324234, 234, District of
                                                    Columbia 5555, United States</option>
                                                <option value="514" selected="selected">a a, 324234 asd,
                                                    sdf, District of Columbia 55554, United States</option>
                                                <option value="">New Address</option>
                                            </select> </div>
                                    </li>
                            ...
                            <script type="text/javascript">
                                //<![CDATA[
                                var shipping = new Shipping('co-shipping-form', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/getAddress/address/', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/saveShipping/',
                                    'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/shippingMethod/');
                                var shippingForm = new VarienForm('co-shipping-form');
                                shippingForm.extraChildParams = ' onchange="shipping.setSameAsBilling(false);"';
                                //shippingForm.setElementsRelation('shipping:country_id', 'shipping:region', 'http://www.portotheme.com/magento/porto/index.php/demo4_en/directory/json/childRegion/', 'Select State/Province...');
                    ...
                    <li id="opc-shipping_method" class="section">
                        ...
                        <div id="checkout-step-shipping_method" class="step a-item" style="display:none;">
                            <form id="co-shipping-method-form" action="">
                                ...
                                <script type="text/javascript">
                                    //<![CDATA[
                                    var shippingMethod = new ShippingMethod('co-shipping-method-form', "https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/saveShippingMethod/");
                                    //]]>
                                </script>
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        if (window.shipping) {
                                            ...
                                            shipping.onSave = function(evt) {
                                                new Ajax.Updater('onepage-checkout-shipping-method-additional-load', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/getAdditional/', {
                                                    onSuccess: function() {
                                                        this.nextStep(evt);
                                                    }.bind(this),
                                                    evalScripts: true
                    ...
                    <li id="opc-payment" class="section">
                        ...
                        <div id="checkout-step-payment" class="step a-item" style="display:none;">
                            <script type="text/javascript">
                                //<![CDATA[
                                var quoteBaseGrandTotal = 304;
                                var checkQuoteBaseGrandTotal = quoteBaseGrandTotal;
                                var quoteGrandTotalClean = quoteBaseGrandTotal;
                                var payment = new Payment('co-payment-form', 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/savePayment/');
                                var lastPrice;
                                //]]>
                            </script>
                            ...
                            <div class="tool-tip" id="payment-tool-tip" style="display:none;">
                                ...
                                <div class="tool-tip-content"><img src="https://www.portotheme.com/magento/porto/skin/frontend/base/default/images/cvv.gif" alt="Card Verification Number Visual Reference" title="Card Verification Number Visual Reference" /></div>
                            </div>
                ...
                <script type="text/javascript">
                    ...
                    var checkout = new Checkout(accordion, {
                        progress: 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/progress/',
                        review: 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/review/',
                        saveMethod: 'https://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/onepage/saveMethod/',
                        failure: 'http://www.portotheme.com/magento/porto/index.php/demo4_en/checkout/cart/'
                    });
                    //]]>
                </script>
            </div>
