...
<footer class="main-footer">
    <div class="pull-right d-none d-sm-inline-block">
	  ...
	  &copy; 2018 <a href="https://adminlte.io">SOA - Refund</a>. All Rights Reserved.
  </footer>
...
<!-- ./wrapper -->
  ...
  <?php
    array_push($mediaFiles['js'], RootREL."media/js/jquery.js");
    array_push($mediaFiles['js'], RootREL."media/js/popper.min.js");
    array_push($mediaFiles['js'], RootREL."media/libs/bootstrap/js/bootstrap.js");
    array_push($mediaFiles['js'], RootREL."media/js/jquery.slimscroll.js");
    array_push($mediaFiles['js'], RootREL."media/js/fastclick.js");
    array_push($mediaFiles['js'], RootREL."media/js/jquery.webticker.min.js");
    array_push($mediaFiles['js'], RootREL."media/js/template.js");
    array_push($mediaFiles['js'], RootREL."media/js/dashboard.js");
    array_push($mediaFiles['js'], RootREL."media/js/demo.js");
  ?>
