 <div class="header-container type3 header-newskin">
             ...
             <div class="top-links-inner">
                 ...
                 <div class="form-language top-select">
                     <select id="select-language" title="Your Language" onchange="window.location.href=this.value" style="width:auto;">
                         ...
                         <option value="http://www.portotheme.com/magento/porto/index.php/demo4_sa/?___from_store=demo4_en" data-image="<?php echo RootREL; ?>media/skin/frontend/smartwave/porto/images/flags/demo4_sa.png">Arabic
                         </option>
                     </select>
                     <script type="text/javascript">
                         (function($) {
                 ...
                 <div class="top-links-area">
                     ...
                     <ul class="links">
                         ...
                         <li class=" last"><a href="http://www.portotheme.com/magento/porto/index.php/demo4_en/customer/account/login/" title="Log In">Log In</a></li>
                     </ul>
                 </div>
     ...
     <div class="header container">
         <h1 class="logo"><strong>Drop Shipping</strong><a href="http://www.portotheme.com/magento/porto/index.php/demo4_en/" title="Magento Commerce" class="logo"><img src="<?php echo RootREL; ?>media/skin/frontend/smartwave/porto/images/logo_white_new.png" alt="Magento Commerce" /></a></h1>
         <div class="cart-area">
             <div class="custom-block"><i class="fas fa-phone" style="margin-right: 11px;font-size:30px;color:#40aee5;"></i><span style="margin-top:-2px;">CALL US NOW<br><b style="color:#fff;font-size:18px;font-weight:600;display:block;line-height:27px;">+123
                         5678 890</b></span> </div>
             <div class="mini-cart">
                             ...
                             <li class="menu-item menu-item-has-children menu-parent-item ">
                                 ...
                                 <div class="nav-sublist-dropdown" style="display: none;">
                                     <div class="container">
                                         <ul>
                                             <li class="menu-item" style="list-style: none;">
                                                 <a class="level1" href="http://www.portotheme.com/magento/porto/index.php/demo4_en/about-porto/"><span>About
                                                         Us</span></a>
                                             </li>
                                             <li class="menu-item" style="list-style: none;">
