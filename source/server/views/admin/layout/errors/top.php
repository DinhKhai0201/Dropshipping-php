...
<head>
    <meta charset="utf-8">
    <title>Việc làm Đà Nẵng | Đăng nhập</title>
  	<meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <meta name="description" content="softdevelopinc">
    <meta name="author" content="softdevelopinc@gmail.com">

    <link rel="stylesheet" href="<?php echo RootREL; ?>media/libs/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo RootREL; ?>media/libs/css/font-awesome.min.css">
  	<link rel="stylesheet" href="<?php echo RootREL; ?>media/libs/admin_lte/AdminLTE.min.css">
