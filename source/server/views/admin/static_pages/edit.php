...
<?php vendor_html_helper::contentheader('Static pages <small>management</small>', [['urlp'=>['ctl'=>$app['ctl'], 'act'=>$app['act']]]]); ?>
			    			...
			    			<div class="col-sm-12">
								<div class="box-body">
									<form id="form-static_pages-edit">
										...
										<input type='text' style="border-radius:5px;width:100%;" name="static_page[slug]" id='title_slug' value="<?=$this->record['title_slug'] ?>" />
										<br /><br />
										...
										<button id="notify-records" class="btn btn-success ml-1 mb-1" data-toggle="modal" data-target="#myModal" type="submit">
