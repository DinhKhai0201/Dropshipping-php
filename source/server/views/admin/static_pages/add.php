...
<?php vendor_html_helper::contentheader('Static page <small>management</small>', [['urlp'=>['ctl'=>$app['ctl'], 'act'=>$app['act']]]]); ?>
			    			...
			    			<div class="col-sm-12">
								<div class="box-body">
									<form id="form-static_pages">
										...
										<input type='text' style="border-radius:5px;width:100%;" name="static_page[slug]" id='title_slug' value="" />
										<br /><br />
