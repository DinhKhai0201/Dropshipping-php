        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 a-left">
                    <ul>
                        <li class="home">
                            <a href="<?php echo vendor_app_util::url(array('area' => '', 'ctl' => '')); ?>"
        ...
        <div class="row">
            <div class="col-main col-lg-9 lg-order-12">
                ...
                <div id="after-loading-success-message">
                    ...
                    <div id="success-message-container" class="loader">
                        ...
                        <button type="button" name="finish_and_checkout" id="finish_and_checkout"
                            class="button btn-cart"><span><span>
                ...
                <p class="category-image"><img
                        src="https://www.portotheme.com/magento/porto/media/catalog/category/men_category_banner.jpg"
                        alt="Categories" title="Categories" /></p>
                        ...
                        <div class="sorter">
                            <div class="sort-by">
                                ...
                                <select onchange="setLocation(this.value)">
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?dir=asc&amp;order=position"
                                        selected="selected">
                                        Position </option>
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?dir=asc&amp;order=name">
                                        Name </option>
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?dir=asc&amp;order=price">
                                        Price </option>
                                </select>
                                <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?dir=desc&amp;order=position"
                                    title="Set Descending Direction"><i class="icon-up"></i></a>
                            </div>

                            <p class="view-mode">
                                <strong title="Grid" class="grid"><i class="fas fa-th"></i></strong>&nbsp;
                                <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?mode=list"
                                    title="List" class="list"><i class="fas fa-list-ul"></i></a>&nbsp;
                            </p>
                            <div class="pager">
                                <p class="amount">
                                ...
                                <div class="pages">
                                    <ol>
                                        ...
                                        <li><a
                                                href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?p=2">2</a>
                                        </li>
                                        ...
                                        <li>
                                            <a class="next i-next"
                                                href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?p=2"
                                                title="Next">
                            ...
                            <div class="limiter">
                                ...
                                <select onchange="setLocation(this.value)">
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?limit=12"
                                        selected="selected">
                                        12 </option>
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?limit=24">
                                        24 </option>
                                    <option
                                        value="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?limit=36">
                                        36 </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <li class="item">
                            <div class="item-area">
                                <div class="product-image-area">
                                    ...
                                    <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/quickview/index/view/id/310"
                                        class="quickview-icon"><i class="icon-export"></i><span>Quick
                                            View</span></a>
                                    <a href="<?php echo (vendor_app_util::url(["ctl" => "product", "act" => "view/" . $products['slug'] . "-" . $products['id']])) ?>"
                                        title="<?php echo $products['name']; ?>" class="product-image">
                                        <img id="product-collection-image-310" class="defaultImage porto-lazyload"
                                            data-src="<?php echo RootREL . 'media/upload/products/' . $products['oneImage']; ?>"
                                            width="300" height="300" />
                                        <img class="hoverImage"
                                            src="<?php echo RootREL . 'media/upload/products/' . $products['oneImage']; ?>"
                                            width="300" alt="Black" />
                                    </a>
                                    <?php if ($products['best_selling'] == 1) { ?>
                                    <div class="product-label" style="right: 10px; "><span
                                            class="new-product-icon">HOT</span></div>
                                    <?php } ?>
                                </div>
                                <div class="details-area">
                                    <h2 class="product-name"><a
                                            href="<?php echo (vendor_app_util::url(["ctl" => "product", "act" => "view/" . $products['slug'] . "-" . $products['id']])) ?>"
                                            title="<?php echo $products['name']; ?>"><?php echo $products['name']; ?></a>
                                    </h2>
                                    <ul class="configurable-swatch-list configurable-swatch-color">
                                        <li class="option-grey is-media" data-product-id="310" data-option-label="grey">
                                            <a href="javascript:void(0)" name="grey"
                                                class="swatch-link swatch-link-92 has-image" title="grey"
                                                style="height: 17px; width: 17px;">
                                                <span class="swatch-label"
                                                    style="height: 15px; width: 15px; line-height: 15px;">
                                                    <img src="https://www.portotheme.com/magento/porto/media/catalog/swatches/1/15x15/media/grey.png"
                                                        alt="grey" width="15" height="15" />
                                                </span>
                                            </a>
                                        </li>
                                        <li class="option-green is-media" data-product-id="310"
                                            data-option-label="green">
                                            <a href="javascript:void(0)" name="green"
                                                class="swatch-link swatch-link-92 has-image" title="green"
                                                style="height: 17px; width: 17px;">
                                                <span class="swatch-label"
                                                    style="height: 15px; width: 15px; line-height: 15px;">
                                                    <img src="https://www.portotheme.com/magento/porto/media/catalog/swatches/1/15x15/media/green.png"
                                                        alt="green" width="15" height="15" />
                                                </span>
                                            </a>
                                        </li>
                                        <li class="option-blue is-media" data-product-id="310" data-option-label="blue">
                                            <a href="javascript:void(0)" name="blue"
                                                class="swatch-link swatch-link-92 has-image" title="blue"
                                                style="height: 17px; width: 17px;">
                                                <span class="swatch-label"
                                                    style="height: 15px; width: 15px; line-height: 15px;">
                                                    <img src="https://www.portotheme.com/magento/porto/media/catalog/swatches/1/15x15/media/blue.png"
                                                        alt="blue" width="15" height="15" />
                                                </span>
                                            </a>
                                        </li>
                                        <li class="option-black is-media" data-product-id="310"
                                            ...
                                            <a href="javascript:void(0)" name="black"
                                                ...
                                                <span class="swatch-label"
                                                    style="height: 15px; width: 15px; line-height: 15px;">
                                                    <img src="https://www.portotheme.com/magento/porto/media/catalog/swatches/1/15x15/media/black.png"
                                                        alt="black" width="15" height="15" />
                                                </span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="actions">
                                        <a href="javascript:void(0)"
                                            onclick="ajaxWishlist(this,'https://www.portotheme.com/magento/porto/index.php/demo1_en/wishlist/index/add/product/310/form_key/5zGu6zv3q1FRWZUJ/','310');"
                                            class="addtowishlist" title="Add to Wishlist"><i
                                                class="icon-wishlist"></i></a>
                                        <a href="javascript:showOptions('310')" class="addtocart" title="Add to Cart"><i
                                                class="icon-cart"></i><span>&nbsp;Add to
                                                Cart</span></a>
                                        <a href='https://www.portotheme.com/magento/porto/index.php/demo1_en/ajaxcart/index/options/product_id/310/'
                                            class='fancybox' id='fancybox310' style='display:none'>Options</a>
                        ...
                        <div class="toolbar">
                            <div class="sorter">
                                ...
                                <p class="view-mode">
                                    ...
                                    <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?mode=list"
                                        title="List" class="list"><i class="icon-mode-list"></i></a>&nbsp;
                                </p>
                                <div class="pager">
                                    <p class="amount">
                                        Items 1 to 12 of 18 total </p>
            ...
            <div class="col-left sidebar f-left col-lg-3">
                ...
                <div class="block-main-layer">
                    <div class="layer-filter-icon visible-sm visible-xs"><a href="javascript:void(0)"><i
                                class="icon-sliders"></i></a></div>
                    <h3 class="title-filter visible-sm visible-xs">Filter Your Selection<span class="close-layer"><i
                                class="icon-cancel"></i></span></h3>
                            ...
                            <ul class="category-list">
                                ...
                                <li class="<?php echo ($haschild1) ? 'has-children' : 'has-no-children'; ?>">
                                    <a href="<?php echo (vendor_app_util::url(["ctl" => "categories", "act" => "index.html?" . $category1['slug'] . "-" . $category1['id']])) ?>">
                                        <?php echo $category1['categoryName']; ?></a><?php if ($haschild1) { ?><a
                                        href="javascript:void(0)" class="plus"><i
                                            class="fas fa-plus"></i></i></a><?php } ?>
                                    <ul>
                                        ...
                                        <li class="<?php echo ($haschild2) ? 'has-children' : 'has-no-children'; ?>">
                                            <a href="<?php echo (vendor_app_util::url(["ctl" => "categories", "act" => "index.html?" . $category2['slug'] . "-" . $category2['id']])) ?>">
                                                <?php echo $category2['categoryName']; ?></a><?php if ($haschild2) { ?><a
                                                href="javascript:void(0)" class="plus"><i
                                                    class="fas fa-plus"></i></i></a><?php } ?>
                                            <ul>
                                                ...
                                                <li
                                                    class="<?php echo ($haschild3) ? 'has-children' : 'has-no-children'; ?>">
                                                    <a href="<?php echo (vendor_app_util::url(["ctl" => "categories", "act" => "index.html?" . $category3['slug'] . "-" . $category3['id']])) ?>">
                                                        <?php echo $category3['categoryName']; ?></a><?php if ($haschild3) { ?><a
                                                        href="javascript:void(0)" class="plus"><i
                                                            class="fas fa-plus"></i></i></a><?php } ?>
                                                    <ul>
                            ...
                            <dl id="narrow-by-list">
                                ...
                                <dd>
                                    <ol class="configurable-swatch-list no-count">
                                        ...
                                        <li style="line-height: 28px;">
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?color=27"
                                                class="swatch-link has-image">
                                                <span class="swatch-label"
                                                    style="height:26px; width:26px; line-height: 28px;">
                                                    <img src="<?php echo RootREL . 'media/img/colors/' . $value . '.png'; ?>"
                                                        alt="<?php echo $value ?>" title="<?php echo $value ?>"
                                                        width="24" height="24" />
                                                </span>
                                            </a>
                                        </li>
                                    ...
                                    <ol class="configurable-swatch-list no-count">
                                        <li>
                                            <span class="swatch-link">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    S </span>
                                            </span>
                                        </li>
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=7"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    M </span>
                                            </a>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=6"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    L </span>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=5"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    XL </span>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=4"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    2XL </span>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=43"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    55 </span>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=42"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    56 </span>
                                        ...
                                        <li>
                                            <a href="https://www.portotheme.com/magento/porto/index.php/demo1_en/categories.html?size=41"
                                                class="swatch-link" style="line-height: 28px;">
                                                <span class="swatch-label"
                                                    style="height:26px; min-width:26px; line-height: 28px;">
                                                    57 </span>
                                ...
                                <dd>
                                    <ol>
                                        ...
                                        <li>
                                            <a
                                                href="<?php echo (vendor_app_util::url(["ctl" => "categories", "act" => "index.html?brand=" . $value['id']])) ?>"><?php echo $value['name']; ?></a>
                                        </li>
                                        <?php } ?>
                                    </ol>
                                </dd>
                ...
                <h5
                    style="font-family:Arial;font-weight:400;font-size:11px;color:#878787;line-height:1;margin-bottom:13px;">
