(function($) {
    ...
    $('.iwj-'+ctl+'-form2').submit(function(e){
        ...
        category_id =   $(this).find('select[name="user[category_id]"]').val();
        ...
        identification_code    = $(this).find('input[name="user[identification_code]"]').val();
        tax_code    = $(this).find('input[name="user[tax_code]"]').val();
        ...
        var checkErr = false;
        if(category_id == 0 && role === 'employer'){
            $('.err-category-name').html("Vui lòng chọn lĩnh vực kinh doanh");
            checkErr = true;
        }else{
        ...
        if(checkErr == false) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status) {
                        location.replace(rootUrl+'register/success_register');
                    }
                },
                error: function (err) {
